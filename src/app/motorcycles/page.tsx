...
export default async function MotorcyclesPage() {
  const motorcycles: Vehicle[] = await getMotorcycles();
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-center mb-12 text-gray-800">🏍️ Motosikletler</h1>

        {motorcycles.length === 0 ? (
          <p className="text-center text-2xl text-gray-600">Henüz motosiklet eklenmemiş.</p>
        ) : (
