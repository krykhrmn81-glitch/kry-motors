        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4 text-lg">
              <p><strong>Şehir ve İlan sahibi:</strong> {vehicle.city} / {vehicle.ownerName}</p>
            ...
            {vehicle.ownerPhone ? (
              <div className='mt-12'>
                <a
                  href={`https://wa.me/${vehicle.ownerPhone.replace(/[^\d]/g, '')}?text=Merhaba,%20${encodeURIComponent(vehicle.brand + ' ' + vehicle.model)}%20ilanınızla%20ilgileniyorum.%20Detay%20görebilir%20miyim?`}
                  target="_blank"
